...
exports.book_delete_post = asyncHandler(async (req, res, next) => {
  ...
  if (allBookInstances.length > 0) {
    // instances detecetd, we cannot delete if they are present
    res.render("book_delete", {
      title: "Delete Book",
      book: book,
      book_instances: allBookInstances,
    ...
    //book has no instances, we can delete
...
exports.book_update_post = [
  // convert the genre to an array as before
  (req, res, next) => {
    if (!Array.isArray(req.body.genre)) {
      req.body.genre =
        typeof req.body.genre === "undefined" ? [] : [req.body.genre];
  ...
  asyncHandler(async (req, res, next) => {
    ...
    // create a book object with escaped/ trimemd data and old id.
    const book = new Book({
      title: req.body.title,
      author: req.body.author,
      summary: req.body.summary,
